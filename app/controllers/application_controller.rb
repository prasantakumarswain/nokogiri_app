      ...
      Category.all.each do |cat|
        ...
        doc.css("#cpProductModuleItems").each do |item|
          ...
          name.each do |link|
            ...
            #buy_product_urls.push(product_descriptions_url)
          ...
          name =  item.css("#itemsdiv div.itemtitle p a")
          #name = name.split("...")
          ...
          name.each_with_index do |product_name,i|
            ...
            @category.products.create(:image => product_image, :name => product_name['title'],:price => product_price,
                                      :description => product_descriptions[i+1],:buy_product => product_name['href'])
          end
        end
      end
    end
